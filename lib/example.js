...
const startSubscriber = () => {
    const options = Object.assign(mqtt_client_1.defaultClientOptions, { port: 8883, host: 'localhost', clientId: 'client1' }, { auth: getAuth() }, { tls: getTLS() });
...
const startPublisher = () => {
    const options = Object.assign(mqtt_client_1.defaultClientOptions, { port: 8883, host: 'localhost', clientId: 'client2' }, { auth: getAuth() }, { tls: getTLS() });
    const client = new mqtt_client_1.MQTTClient(options, new logger_1.ConsoleLogger(logger_types_1.LogLevel.INFO));
    client.connect();
    setInterval(() => {
